  ...
  document.body.insertAdjacentHTML('beforeend',`<div id="cartDrawer" class="cart-drawer" hidden>
    ...
    <aside class="cart-panel" role="dialog" aria-modal="true" aria-labelledby="cartTitle">
      ...
      <div class="cart-foot">
        ...
        <small class="checkout-secure-note"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i> Secure order confirmation • WhatsApp opens after your order is saved</small>
      </div>
    </aside>
  </div>`);
...
function setupProductRail(trackSelector, prevSelector, nextSelector, interval=4500){
...
function setupFeaturedSlider(){
  setupProductRail('#featured','[data-featured-prev]','[data-featured-next]',4300);
}
...
function setupHeaderSearchNavigation(){
  // Native GET form submission is intentionally used as the primary path.
  // This keeps search functional even if JavaScript is delayed or unavailable.
