...
V32 Green + Off-White UI: complete storefront visual theme migration. Product/cart/order/API behavior preserved from V31. Google Apps Script backend unchanged.
